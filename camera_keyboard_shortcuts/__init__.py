...
bl_info = {
    ...
    "blender": (2, 93, 0),
    "location": "",
    "description": "This will adjust the interocular or convergence distance for the current camera in the scene. " \
                   ...
                   "This will toggle the background images checkbox for the current camera in a scene. " \
                   "To run this, make a keyboard shortcut and put in this... wm.camera_keyboard_shortcuts_toggle_background_images ...for the " \
                   "action of toggling the image on and off. Put in this... wm.camera_keyboard_shortcuts_toggle_alpha ..." \
                   "for the action of switching between an alpha value of 1 and 0.6."\
                   "If you want to call this manually from Python, use this... bpy.ops.wm.camera_keyboard_shortcuts_toggle_background_images() " \
                   "...or this: bpy.ops.wm.camera_keyboard_shortcuts_toggle_alpha()"
                   "This will toggle between 2D, anaglyph, two line interlaced 3D modes. " \
                   "To run this, make a keyboard shortcut and put in the following commands: " \
                   "wm.camera_keyboard_shortcuts_toggle_3d_mode " \
                   "If you want to call this manually from Python, use one of the following commands: " \
                   "bpy.ops.wm.camera_keyboard_shortcuts_toggle_3d_mode() ",
